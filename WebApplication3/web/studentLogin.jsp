...
.tile .tile-header {
  background-image: url("http://www.plgpl.org/images/banner6.jpg");
...
@keyframes dot-bounce {
  ...
  50% {
    ...
    -webkit-transform: scale(1);
        ...
        <body>
    <div class="tile">
        <h2 style="color: BLACK; opacity: .75; font-size: 2rem; display: flex; justify-content: center; align-items: center; height: 100%;">STUDENT-LOGIN</h2>
  <div class="tile-header">
   
  </div>
  
  <div class="tile-body">
      <form id="form" action="/WebApplication3/studentHome.jsp" method="POST">
      ...
      <div class="submit-container clearfix" style="margin-top: 2rem;">          
        <div id="submit" role="button" type="button" class="btn btn-irenic float-right" tabindex="0">
            <input type="submit" class="btn btn-irenic float-right" value="SIGN-IN">
        </div>
