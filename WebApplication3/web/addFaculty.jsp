...
<nav class="navbar-primary">
  ...
  <div align="center">
            ...
            <form action="/WebApplication3/AddFaculty" method="post">
        ...
        <table border="1" cellpadding="5">
            ...
            <tr>
                <th>Designation: </th>
                <td>
                    <input type="text" name="designation" size="45" required/>
                </td>
            </tr>
                        <tr>
                <th>Qualification: </th>
                <td>
                    <input type="text" name="qualification" size="45" required/>
                </td>
            </tr>
                   <tr>
                <th>Institute Of Education: </th>
                <td>
                    <input type="text" name="institute" size="45" required/>
                </td>
            </tr>
                   <tr>
                <th>Contact Number </th>
                <td>
                    <input type="number" name="contact" size="45" required/>
                </td>
            </tr>
                   <tr>
                <th>Email ID: </th>
                <td>
                    <input type="email" name="emailId" size="45" required/>
                </td>
            </tr>
            <tr>
                <th>Username: </th>
