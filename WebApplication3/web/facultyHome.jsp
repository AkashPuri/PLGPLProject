...
<nav class="navbar-primary">
  ...
  <ul class="navbar-primary-menu">
    <li>
      ...
      <a href="#"><span class="glyphicon glyphicon-list-alt"></span><span class="nav-label">sjdf</span></a>
      <a href="#"><span class="glyphicon glyphicon-stats"></span><span class="nav-label">jskcn</span></a>
  </ul>
</nav>
