...
<button class="btn info">Personal Time-Table</button><br>
<button class="btn warning">Teaching Plan(D-1)</button><br>
<button class="btn danger">Lab. Assignment/Sheets/Job/Project</button><br>
<button class="btn default">Student's Theory Attendance</button><br>
<button class="btn info">Student's Practical Attendance</button><br>

<button class="btn warning">Progressive Assessment of Practicals D-3/ D-4(G)</button><br>
<button class="btn danger">Progressive Assessment of Practicals for non-theory subjects D-3(A)</button><br>

<button class="btn info">Progressive Assessment Theory D-5</button><br>
<button class="btn warning">Sessional Test Result Analysis</button><br>
<button class="btn info">Status of percentage of syllabus covered</button><br>
<button class="btn success">Faculty Profile</button><br>
