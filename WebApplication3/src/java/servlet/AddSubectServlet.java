 ...
 * @author MADHAVAN
 */
@WebServlet(name = "AddSubectServlet", urlPatterns = {"/AddSubectServlet"})
public class AddSubectServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          String time = request.getParameter("time");
            ...
            System.out.println(subject+""+facultyName+""+time);
