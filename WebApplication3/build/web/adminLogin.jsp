...
@keyframes dot-bounce {
  ...
  50% {
    ...
    -webkit-transform: scale(1);
        ...
        <body>
    <div class="tile">
        <h2 style="color: BLACK; opacity: .75; font-size: 2rem; display: flex; justify-content: center; align-items: center; height: 100%;">ADMIN-LOGIN</h2>
  <div class="tile-header">
   
  </div>
  
  <div class="tile-body">
      <form id="form" action="/WebApplication3/adminHome.jsp" method="POST">
